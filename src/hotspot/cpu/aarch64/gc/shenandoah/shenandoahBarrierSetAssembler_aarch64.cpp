...
void ShenandoahBarrierSetAssembler::keepalive_barrier_c1_stub(LIR_Assembler* ce, ShenandoahKeepaliveBarrierStub* stub) {
  ...
  __ far_call(RuntimeAddress(bs->keepalive_barrier_c1_runtime_code_blob()->code_begin()));
