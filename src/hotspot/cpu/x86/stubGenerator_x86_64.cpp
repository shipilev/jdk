...
#define inc_counter_np(counter) \
      ...
      __ BIND(L_small_qwords_8);
        if (UseUnalignedLoadStores) {
          ...
          if (UseAVX >= 2) {
            ...
            for (int i = 0; i < 2; i++) {
              __ vmovdqu(Address(end_to, qword_count, Address::times_8, i * 32 - 64), as_XMMRegister(i));
            }
          } else {
            for (int i = 0; i < 4; i++) {
              __ movdqu(as_XMMRegister(i), Address(end_from, qword_count, Address::times_8, i * 16 - 64));
            }
            for (int i = 0; i < 4; i++) {
              __ movdqu(Address(end_to, qword_count, Address::times_8, i * 16 - 64), as_XMMRegister(i));
            }
          }
        } else {
          for (int i = 0; i < 8; i++) {
            __ movq(rax, Address(end_from, qword_count, Address::times_8, i * 8 - 64));
            __ movq(Address(end_to, qword_count, Address::times_8, i * 8 - 64), rax);
          }
        }
        __ addptr(qword_count, 8);
        __ jccb(Assembler::lessEqual, L_small_qwords_8);
      ...
      __ jccb(Assembler::greater, L_small_qwords_2);
        if (UseUnalignedLoadStores) {
          if (UseAVX >= 2) {
            ...
            __ vmovdqu(Address(end_to, qword_count, Address::times_8, -32), xmm0);
          } else {
            for (int i = 0; i < 2; i++) {
              __ movdqu(as_XMMRegister(i), Address(end_from, qword_count, Address::times_8, i * 16 -32));
            }
            for (int i = 0; i < 2; i++) {
              __ movdqu(Address(end_to, qword_count, Address::times_8, i * 16 -32), as_XMMRegister(i));
            }
          }
        } else {
          for (int i = 0; i < 4; i++) {
            __ movq(rax, Address(end_from, qword_count, Address::times_8, i * 8 -32));
            __ movq(Address(end_to, qword_count, Address::times_8, i * 8 -32), rax);
          }
        }
    ...
    __ BIND(L_small_qwords_2);
      ...
      __ jccb(Assembler::greater, L_small_qwords_1);
        if (UseUnalignedLoadStores) {
          ...
          __ movdqu(xmm0, Address(end_from, qword_count, Address::times_8, -16));
          __ movdqu(Address(end_to, qword_count, Address::times_8, -16), xmm0);
        } else {
          for (int i = 0; i < 2; i++) {
            __ movq(rax, Address(end_from, qword_count, Address::times_8, i * 8 -16));
            __ movq(Address(end_to, qword_count, Address::times_8, i * 8 -16), rax);
          }
        }
  ...
  void copy_bytes_backward_small(Register from, Register to,
    ...
    if (unit_size <= 1) {
      __ testptr(byte_count, 1);
      __ jccb(Assembler::zero, L_small_qwords_8_enter);
    ...
    __ BIND(L_small_qwords_8_enter);
      ...
      __ BIND(L_small_qwords_8);
        if (UseUnalignedLoadStores) {
          ...
          if (UseAVX >= 2) {
            ...
            for (int i = 0; i < 2; i++) {
              __ vmovdqu(Address(to, qword_count, Address::times_8, -i*32 -32 +64), as_XMMRegister(i));
            }
          } else {
            for (int i = 0; i < 4; i++) {
              __ movdqu(as_XMMRegister(i), Address(from, qword_count, Address::times_8, -i*16 -16 +64));
            }
            for (int i = 0; i < 4; i++) {
              __ movdqu(Address(to, qword_count, Address::times_8, -i*16 -16 +64), as_XMMRegister(i));
            }
          }
        } else {
          for (int i = 0; i < 8; i++) {
            __ movq(rax, Address(from, qword_count, Address::times_8, -i*8 -8 +64));
            __ movq(Address(to, qword_count, Address::times_8, -i*8 -8 +64), rax);
          }
        }
        __ subptr(qword_count, 8);
        __ jccb(Assembler::greaterEqual, L_small_qwords_8);
        __ addptr(qword_count, 8);
