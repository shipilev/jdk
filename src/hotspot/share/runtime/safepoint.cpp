...
void SafepointTracing::end() {
  ...
  log_info(safepoint)(
     "Safepoint \"%s\", "
     "Reaching: " JLONG_FORMAT " us, "
     "At: " JLONG_FORMAT " us, "
     "Leaving: " JLONG_FORMAT " us, "
     "Total: " JLONG_FORMAT " us, "
     "Threads: %d of %d",
      VM_Operation::name(_current_type),
      (_last_safepoint_sync_time_ns  - _last_safepoint_begin_time_ns) / 1000,
      (_last_safepoint_leave_time_ns - _last_safepoint_sync_time_ns) / 1000,
      (_last_safepoint_end_time_ns   - _last_safepoint_leave_time_ns) / 1000,
      (_last_safepoint_end_time_ns   - _last_safepoint_begin_time_ns) / 1000,
      _nof_running,
      _nof_threads
     );
