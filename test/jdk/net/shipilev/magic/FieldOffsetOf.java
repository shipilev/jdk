...
/*
 * @test
 * @summary Test for Magic.fieldOffsetOf with 32-bit compressed oops
 * @library /test/lib
 *
...
/*
 * @test
 * @summary Test for Magic.fieldOffsetOf with zero-based compressed oops
 * @library /test/lib
 * @requires vm.bits == 64
 *
...
/*
 * @test
 * @summary Test for Magic.fieldOffsetOf without compressed oops
 * @library /test/lib
 * @requires vm.bits == 64
 *
...
public class FieldOffsetOf {
    ...
    private static void testInstanceOffsets() throws Exception {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.fieldOffsetOf(f));
        }
    }
    ...
    private static void testStaticOffsets() throws Exception {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertNotEquals(0,  Magic.fieldOffsetOf(f));
            MagicUtil.assertNotEquals(-1, Magic.fieldOffsetOf(f));
        }
    }
