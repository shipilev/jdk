...
/*
 * @test
 * @summary Test for Magic.sizeOf with 32-bit compressed oops
 * @library /test/lib
 *
...
/*
 * @test
 * @summary Test for Magic.sizeOf with zero-based compressed oops
 * @library /test/lib
 * @requires vm.bits == 64
 *
 * @build jdk.test.whitebox.WhiteBox
...
/*
 * @test
 * @summary Test for Magic.sizeOf without compressed oops
 * @library /test/lib
 * @requires vm.bits == 64
 *
 * @build jdk.test.whitebox.WhiteBox
...
public class SizeOf {
    ...
    private static void testSize_newObject() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(new Object()));
        }
    }
    ...
    private static void testSize_localObject() {
        ...
        Object o = new Object();
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(o));
        }
    }
    ...
    private static void testSize_fieldObject() {
        int expected = roundUp(Platform.is64bit() ? 16 : 8, A);
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(staticO));
        }
    }
    ...
    private static void testSize_newSmallByteArray() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(new byte[1024]));
        }
    }
    ...
    private static void testSize_localSmallByteArray() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(arr));
        }
    }
    ...
    private static void testSize_fieldSmallByteArray() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(smallArr));
        }
    }
    ...
    private static void testSize_newSmallObjArray() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(new Object[1024]));
        }
    }
    ...
    private static void testSize_fieldSmallObjArray() {
        ...
        for (int c = 0; c < MagicUtil.ITERS; c++) {
            MagicUtil.assertEquals(expected, Magic.sizeOf(smallObjArr));
        }
    }
